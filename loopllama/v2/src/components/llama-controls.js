...
const MENUS = [
  {
    label: 'Video',
    items: [
      { label: 'Load URL',        action: 'videoUrl',          hint: 'y / vu' },
      { label: 'Open video',      action: 'videoPickerRecent', hint: 'vv'     },
      { label: 'Edit current',    action: 'editVideo',         hint: 've'     },
      { label: 'Video info',      action: 'videoInfo',         hint: 'vi'     },
      { label: 'Loop full video', action: 'loopVideo',         hint: 'vl / lv' },
      { label: 'Delete video',    action: 'deleteVideo',       hint: 'vd'     },
      { type: 'divider' },
      { label: 'Create chapter divider here', action: 'setChapter',    hint: 'cc'      },
      { label: 'Open chapter',               action: 'openChapter',   hint: 'co'      },
      { label: 'Edit chapter',               action: 'editChapter',   hint: 'ce'      },
      { label: 'Loop current chapter',       action: 'loopChapter',   hint: 'cl / lc' },
      { label: 'Delete chapter',             action: 'deleteChapter', hint: 'cd'      },
      { label: 'Zoom current chapter',       action: 'zoomChapter',   hint: 'cz'      },
      { label: 'Fix chapter end',            action: 'fixChapter',    hint: 'cf'      },
    ],
  },
  {
    label: 'Section',
    items: [
      { label: 'Set section here',         action: 'setSection',    hint: 'ss'      },
      { label: 'Edit current section',     action: 'editSection',   hint: 'se'      },
      { label: 'Open section',             action: 'openSection',   hint: 'so'      },
      { label: 'Loop current section',     action: 'loopSection',   hint: 'sl / ls' },
      { label: 'Delete section',           action: 'deleteSection', hint: 'sd'      },
      { label: 'Zoom current section',     action: 'zoomSection',   hint: 'sz'      },
      { label: 'Fix section end',          action: 'fixSection',    hint: 'sf'      },
      { type: 'divider' },
      { label: 'Toggle zone 2 (sections/chapters)', action: 'toggleZone2', hint: 'tt' },
    ],
  },
  {
    label: 'Loop',
    items: [
      ...
      { label: 'Loop full video',      action: 'loopVideo',   hint: 'vl / lv' },
      { type: 'divider' },
      { label: 'Open loop',                action: 'openLoop',          hint: 'lo'      },
      { label: 'Save new loop',            action: 'saveLoop',          hint: 'ln'      },
      { label: 'Save back to loop source', action: 'saveBack',          hint: 'lb'      },
      { label: 'Reset loop to source',     action: 'resetLoopToSource', hint: 'l='      },
      { label: 'Unlink loop source',       action: 'unlinkLoopSource',  hint: 'l⌫'     },
      { label: 'Delete loop',              action: 'deleteLoop',        hint: 'ld'      },
      { label: 'Zoom current loop',        action: 'zoomLoop',          hint: 'lz'      },
      { type: 'divider' },
      { label: 'Edit scratch loop', action: 'editScratch', hint: 'le / \\' },
    ],
  },
  {
    label: 'Mark',
    items: [
      { label: 'Set mark here', action: 'setMark',    hint: 'mm' },
      { label: 'Edit mark',     action: 'editMark',   hint: 'me' },
      { label: 'Delete mark',   action: 'deleteMark', hint: 'md' },
    ],
  },
  {
    label: 'Jump',
    items: [
      { label: 'Jump to Chapter', action: 'jumpChapter', hint: 'jc' },
      { label: 'Jump to Section', action: 'jumpSection', hint: 'js' },
      { label: 'Jump to Loop',    action: 'jumpLoop',    hint: 'jl' },
      { label: 'Jump to Mark',    action: 'jumpMark',    hint: 'jm' },
      { type: 'divider' },
      { label: 'Jump history',  action: 'jumpHistory', hint: 'jh' },
      { label: 'Jump Back',     action: 'jumpBack',    hint: 'jb' },
      { label: 'Jump Forward',  action: 'jumpForward', hint: 'jf' },
    ],
  },
  {
    label: 'App',
    items: [
      { label: 'Undo',  action: 'undo', hint: 'u' },
      { label: 'Redo',  action: 'redo', hint: 'U' },
      { type: 'divider' },
      { label: 'Share video', action: 'shareVideo', hint: 'dv' },
      { label: 'Share loop',  action: 'shareLoop',  hint: 'dl' },
      { type: 'divider' },
      { label: 'Export all data',        action: 'exportAll',   hint: 'de' },
      { label: 'Import data',            action: 'importData',  hint: 'di' },
      { label: 'Inspect JSON',           action: 'inspectData', hint: 'dI' },
      { type: 'divider' },
      { label: 'Save data to cloud',     action: 'dataSave',    hint: 'ds' },
      { label: 'Read data from cloud',   action: 'dataRead',    hint: 'dr' },
      { label: 'Compare local vs cloud', action: 'dataCompare', hint: 'dc' },
      { label: 'Recall last message',    action: 'msgRecall',   hint: 'dm' },
      { type: 'divider' },
      { label: 'Bulk data delete', action: 'deleteData', hint: 'dd' },
      { label: 'Options',          action: 'options',    hint: 'o'  },
    ],
  },
  {
    label: 'Help',
    items: [
      { label: 'General help', action: 'helpGeneral', hint: 'hh'    },
      { label: 'Key bindings', action: 'helpKeys',    hint: 'hk / ?' },
    ],
  },
];
