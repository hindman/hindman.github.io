...
const MENUS = [
  {
    ...
    items: [
      ...
      { type: 'divider' },
      { label: 'Create chapter divider here', action: 'setChapter'    },
      ...
      { label: 'Fix chapter end',            action: 'fixChapter'    },
    ],
  },
  {
    label: 'Section',
    items: [
      ...
      { label: 'Fix section end',          action: 'fixSection'    },
      { type: 'divider' },
      { label: 'Toggle zone 2 (sections/chapters)', action: 'toggleZone2' },
    ],
  },
  {
    label: 'Loop',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Share loop',  action: 'shareLoop'  },
      { type: 'divider' },
      ...
      { label: 'Recall last message',  action: 'msgRecall' },
      { type: 'divider' },
