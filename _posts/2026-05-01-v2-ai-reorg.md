...
Agriculture in the US provides a helpful example:
  - Economic historians estimate that more than half of the labor force
    worked in agriculture in the mid 19c.
  - In earlier periods, the number was likely higher, but our data sources
    are less solid.
  - By 1900 that figure was roughly 40%, about 17% in 1940 (assembly lines
    at an advanced stage in some industries), less than 5% by 1980, and
    less than 2% today.
  - Viewed through one lens, that looks like the destruction of fully half
    of the jobs that existed in the mid 19c.
...
### AI seems likely to increase worker productivity
