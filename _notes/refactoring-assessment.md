...
[Put a proposed implmentation staging plan here, as a table, under the
assumption that we decide to address all of the items (we might not).]

    Session | Focus          | Items           | Status
    -------------------------------------------------------------------
    1       | Foo bar        | R3.1            | .
    2       | Blah blah blah | R3.2, R3.6, etc | .
    etc
